...
TIP: Weitere Informationen zur Astra Trident Architektur auf dem Kubernetes Cluster sind unter link:../trident-get-started/architecture.html["Architektur von Trident"] zu finden.
