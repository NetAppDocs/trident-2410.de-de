...
Trident wird von als bereitstellung identifiziert, die für diese Klasse verwendet wird. Trident wird darin https://kubernetes.io/docs/concepts/storage/storage-classes/["Kubernetes StorageClass-Objekt"^] angewiesen, ein Volume bereitzustellen. Beispiel:
