...
* *CVS-Performance*: Der Standard-Trident-Servicetyp. Dieser leistungsoptimierte Service-Typ eignet sich am besten für Produktions-Workloads, bei denen Performance im Vordergrund steht. Der CVS-Performance-Service-Typ ist eine Hardwareoption, die Volumes mit einer Mindestgröße von 100 GiB unterstützt. Eine der folgenden Optionen kann gewählt werden link:https://docs.cloud.google.com/netapp/volumes/docs/discover/overview["Drei Service-Level"^]:
+
** `standard`
** `premium`
** `extreme`
