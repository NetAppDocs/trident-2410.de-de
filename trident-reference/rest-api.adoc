...
[role="lead"]
Während link:../trident-managing-k8s/tridentctl.html["Tridentctl-Befehle und -Optionen"] der einfachste Weg ist, mit der Astra Trident REST API zu interagieren, kann alternativ auch direkt der REST-Endpunkt verwendet werden.
