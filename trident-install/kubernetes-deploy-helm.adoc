...
.Bevor Sie beginnen
Zusätzlich zu dem link:kubernetes-deploy.html#before-you-begin["Voraussetzungen für die Implementierung"] benötigen Sie link:https://v3.helm.sh/["Helm Version 3"^].
